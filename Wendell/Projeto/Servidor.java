...
public class Servidor {
    ...
    //Metodo construtor da classe servidor
    public Servidor(String nome, String telefone, String endereco, String sexo, int idade, double salario, double desconto, int numerohoras){
    }
      //Metodo para calcular o saldo do FGTS

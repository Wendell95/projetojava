...
public class Administrador {
    ...
    //Metodo construtor da classe administrador
    public Administrador(String nome, String telefone, String endereco, String sexo, int idade, double salario, double desconto, int numerohoras){
    }
    //metodo para Calcular o saldo fgts
    ...
    //metodo para Calcular o INSS
     ...
     //metodo para Calcular a hora extra trabalhada

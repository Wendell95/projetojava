...
public class Diretor {
    ...
    //Metodo construtor da classe Diretor
    public Diretor(String nome, String telefone, String endereco, String sexo, int idade, double salario, double desconto, int numerohoras){
    }
